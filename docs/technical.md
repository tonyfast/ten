...
---
    ...
    [NbConvertApp] Writing 356091 bytes to technical.html
    ...
    [NbConvertApp] Making directory technical_files
    [NbConvertApp] Making directory technical_files
    [NbConvertApp] Writing 35793 bytes to technical.md
    [NbConvertApp] Converting notebook technical.ipynb to python
    [NbConvertApp] Writing 10095 bytes to technical.py
